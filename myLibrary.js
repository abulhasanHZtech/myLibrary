class DesignerTool {
                  ...
                  >
                    ...
                    >
                      <div class="tab_header mb-3">
                        ...
                        <label class="text_sm letter_spacing font_semibold mb-1"
                          >URL</label
                        >
                        <input
                          type="url"
                        ...
                        />
                        <p class="text_sm letter_spacing mb-2">
                          Enter your URL for QR code generation
                        </p>
            ...
            <div class="canvas_wrapper h-100">
              <div class="canvas_wrapper_header">
                ...
                <div class="btn_groups">
                  <button class="custom_btn border_btn">
              ...
              <div class="main-canva" id="canvasContainer">
                <!-- <div class="backside-addressbox"></div> -->
  ...
  initializeTool() {
    ...
    function shortenImageUrl(dataUrl, callback) {
      const imageData = dataUrl.split(",")[1];

      fetch("https://postautopilot.com/version-test/api/1.1/obj/test", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer 9ab0cc4380d5f623e629a13016bc5603",
        },
        body: JSON.stringify({
          image: {
            filename: "image.jpg",
        ...
        .then((data) => {
          ...
          return fetch(
            `https://postautopilot.com/version-test/api/1.1/obj/test/${imageId}`,
            {
              method: "GET",
              headers: {
                Authorization: "Bearer 9ab0cc4380d5f623e629a13016bc5603",
        ...
        .then((response) => response.json())
        .then((data) => {
          let shortUrl = data.response.image;
    ...
    document
      ...
      .addEventListener("click", function (event) {
        ...
        shortenImageUrl(qrDataUrl, function (shortUrl) {
          fabric.Image.fromURL(shortUrl, function (img) {
            img.set({
              left: 50,
              top: 50,
              selectable: true,
    ...
    document
      ...
      .addEventListener("change", function (event) {
        ...
        reader.onload = function (e) {
          ...
          shortenImageUrl(dataUrl, function (shortUrl) {
    ...
    document
      ...
      .addEventListener("click", function (event) {
        ...
        shortenImageUrl(imageUrl, function (shortUrl) {
          addImageToCanvas(shortUrl);
        });
      });
    ...
    function convertCanvasToHTML(canvas) {
      ...
      canvas.getObjects().forEach((obj, index) => {
        if (obj.type === "textbox") {
          ...
          styles.push(
            `.textbox-${index} p { position: absolute; left: ${obj.left}px; top: ${obj.top}px; width: ${obj.width}px; font-size: ${obj.fontSize}px; font-weight:${obj.fontWeight}; color:${obj.fill}; font-family: ${obj.fontFamily}; }`
          );
