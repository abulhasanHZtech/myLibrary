class DesignerTool{constructor(containerId){this.containerId=containerId;this.init()}loadDependencies(callback){const dependencies=[{type:"css",url:"https://unpkg.com/filepond/dist/filepond.min.css"},{type:"css",url:"https://cdn.quilljs.com/1.3.6/quill.snow.css"},{type:"css",url:"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"},{type:"css",url:"https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css"},{type:"css",url:"https://cdnjs.cloudflare.com/ajax/libs/prism/1.23.0/themes/prism.min.css"},{type:"js",url:"https://cdnjs.cloudflare.com/ajax/libs/prism/1.23.0/prism.min.js"},{type:"js",url:"https://cdnjs.cloudflare.com/ajax/libs/prism/1.23.0/components/prism-html.min.js"},{type:"js",url:"https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"},{type:"js",url:"https://code.jquery.com/jquery-3.5.1.slim.min.js"},{type:"js",url:"https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js"},{type:"js",url:"https://cdn.quilljs.com/1.3.6/quill.js"},{type:"js",url:"https://cdn.rawgit.com/davidshimjs/qrcodejs/gh-pages/qrcode.min.js"},{type:"js",url:"https://cdnjs.cloudflare.com/ajax/libs/fabric.js/4.4.0/fabric.min.js"}];const loadScript=(src,callback)=>{const script=document.createElement("script");script.src=src;script.onload=callback;document.head.appendChild(script)};const loadStyle=(href,callback)=>{const link=document.createElement("link");link.rel="stylesheet";link.href=href;link.onload=callback;document.head.appendChild(link)};const loadNext=index=>{if(index>=dependencies.length){callback();return}const dependency=dependencies[index];if(dependency.type==="js"){loadScript(dependency.url,()=>loadNext(index+1))}else if(dependency.type==="css"){loadStyle(dependency.url,()=>loadNext(index+1))}};loadNext(0)}addCustomStyles(){const style=document.createElement("style");style.innerHTML=`
#canvas-container {
